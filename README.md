...
Olá, como vai?! Meu nome é Gabriel Miranda e acabei de fazer um crud onde melhorei minhas habilidades com front end e back end.
...
> **Project Feature:**  *aplicação web* 🌐 
 ...
 Este projeto consiste em um crud com `javascript`, `nodejs(express.js)` e `mongoDB`, onde faço as seguintes funcionalidades:
...
| :----------------- | :------------------------- | :----------: |
| <a href="https://vuejs.org/"><img align="center" alt="vue" height="30" width="40" src="https://github.com/devicons/devicon/blob/master/icons/html5/html5-original.svg"></a>| Java  |  `18.0.0`       |
